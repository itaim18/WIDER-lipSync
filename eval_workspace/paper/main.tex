...
\midrule
    latentsync\_fast & -0.05 & -12 & 0.960 & 6.7 & 13.9 & 0.813 & 0.107 & 1.32 \\
    latentsync\_occfix & -0.01 & 4 & 0.946 & 6.9 & 14.5 & 0.700 & 0.155 & 1.37 \\
    latentsync\_smooth & -0.05 & -12 & 0.959 & 6.8 & 14.4 & 0.816 & 0.106 & 1.33 \\
    musetalk\_occfix & -0.04 & -12 & 0.786 & 5.1 & 9.6 & 0.806 & 0.198 & 0.95 \\
    musetalk\_raw & -0.05 & -12 & 0.789 & 4.9 & 9.0 & 0.814 & 0.206 & 0.88 \\
\bottomrule
\end{tabular}%
}
\end{table}
...
Strengths: strong identity preservation (0.960); high mouth fidelity (LPIPS=0.107). Weaknesses: low sync confidence (-0.05); notable AV offset (-12 frames). 
...
Strengths: strong identity preservation (0.959); high mouth fidelity (LPIPS=0.106). Weaknesses: low sync confidence (-0.05); notable AV offset (-12 frames). 
...
Strengths: smooth temporal transitions (MAD=4.9). Weaknesses: low sync confidence (-0.05); notable AV offset (-12 frames). 

\section{Discussion}

The highest sync confidence was achieved by latentsync\_occfix (-0.01). Best identity preservation was by latentsync\_fast (0.960). The smoothest temporal transitions were from musetalk\_raw (MAD=4.9). 
